...
function showmymap(){var e=document.getElementById("myinput"),t={lat:37.3382082,lng:-121.88632860000001},a={center:t,zoom:15,scrollwheel:!1}
map=new google.maps.Map(mapdiv,a),autocomplete=new google.maps.places.Autocomplete(e,{types:["(cities)"]}),autocomplete.addListener("place_changed",_navigate)}function _navigate(){_moveto={lat:autocomplete.getPlace().geometry.location.lat(),lng:autocomplete.getPlace().geometry.location.lng()},mybutton.onclick=function(){return markers.forEach(function(e){e.setMap(null)}),markers=[],""===_lookingfor.value.trim()?void alert("Oops! Looks like you haven't keyed in the place/Location you are searching for/in"):(console.log("looking for "+_lookingfor.value.trim()+" in the co-ordinates "+_moveto.lat+","+_moveto.lng),void initialize(_moveto,_lookingfor.value.trim()))}}function initialize(e,t){map.setCenter(e),infowindow=new google.maps.InfoWindow
var a=new google.maps.places.PlacesService(map)
a.textSearch({location:e,radius:500,query:t,zoom:15,scrollwheel:!1},callback)}function callback(e,t){if($("html, body").animate({scrollTop:$("#map-canvas").offset().top},2e3),t===google.maps.places.PlacesServiceStatus.OK){document.getElementById("carcontent").innerHTML=""
var a=[]
_totalpointers=e.length
for(var o=0;o<e.length;o++)add_to_carousel(o,e[o]),createMarker(o,e[o]),"undefined"!=typeof e[o].rating&&e[o].rating>=0?a[o]=[e[o].name,e[o].rating]:a[o]=[e[o].name,0]
a.forEach(function(e){0===e[1]&&a.splice(a.indexOf(e),1)}),aggregate(a)}}function createMarker(e,t){var a=(t.geometry.location,new google.maps.Marker({name:t.name,map:map,position:t.geometry.location,animation:google.maps.Animation.DROP,locindex:e,icon:"/pages/img/zicon.png"}))
0===e&&a.setAnimation(google.maps.Animation.BOUNCE),markers[e]=a
var o="number"==typeof t.rating?t.rating:0,n="number"==typeof t.minPriceLevel?t.minPriceLevel:0
drawcharts(o,n,e),google.maps.event.addListener(a,"click",function(){infowindow.setContent(t.name),infowindow.open(map,this),markers.forEach(function(e){e.setAnimation(null)}),this.setAnimation(google.maps.Animation.BOUNCE),$(".carousel").carousel(a.locindex)})}function add_to_carousel(e,t){var a="undefined"==typeof t.formatted_phone_number?"(N/A)":t.formatted_phone_number,o=t.types,n=" "
o.forEach(function(e){n+="<li>"+e.toUpperCase()+"</li>"})
